...
enum class AwsExplorerService(val serviceId: String, val displayName: String) {
    ...
    CLOUDWATCH(CloudWatchLogsClient.SERVICE_NAME, message("explorer.node.cloudwatch")) {
        override fun buildServiceRootNode(project: Project) = CloudWatchLogsServiceNode(project)
    },
